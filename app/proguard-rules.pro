...
# Xposed
-keep class com.yxer.rpack.hook.hooks.RoXposedHook
#-keep class com.yxer.rpack.hook.hooks.RoXpServer

# Config
-keep class com.yxer.rpack.hook.hooks.JsonConfig { *; }
-keep class com.yxer.rpack.hook.hooks.JsonConfig$* { *; }

# 将文件来源重命名为“ProguardFile”字符串
-renamesourcefileattribute ProguardFile
# 保留行号
-keepattributes SourceFile,LineNumberTable
# 保持异常不被混淆
